...
void MBL(void)         // MOTOR BACK LEFT
    {
         
      PORTB.0=0;
      PORTB.1=1;       //Red-Black Right
      PORTB.7=1;
    } 
    
    
    void MBR(void)     // MOTOR BACK RIGHT
    {
         
      PORTE.6=1;
      PORTE.7=0;   //White-Yellow Right
      PORTB.6=1;
    } 
    
    void MFL(void)   // MOTOR Front LEFT
    {
    ...
    void MFR(void)  // MOTOR Front Right
    {
...
// State: Bit7=T Bit6=T Bit5=T Bit4=1 Bit3=1 Bit2=1 Bit1=0 Bit0=0 
PORTA=(0<<PORTA7) | (0<<PORTA6) | (0<<PORTA5) | (1<<PORTA4) | (1<<PORTA3) | (1<<PORTA2) | (0<<PORTA1) | (0<<PORTA0);
